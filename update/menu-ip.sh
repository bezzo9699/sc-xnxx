...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}                 • NovanStore •                 $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e ""
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/izin-xnxx/main/ip | awk '{print $4}' | grep $daftar)
...
echo "### $client $exp $daftar $isadmin" >>/root/izin-xnxx/ip 
git add .
git commit -m register &> /dev/null
git branch -M ipuk &> /dev/null
git remote add origin https://github.com/${USERGIT}/izin-xnxx.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/izin-xnxx.git &> /dev/null
sleep 1
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/izin-xnxx.git
cd /root/izinvps/
rm -rf .git
git init
touch ip
...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/root/izin-xnxx/ip")
...
sed -i "s/### $name1 $exp $ivps1/### $name1 $exp4 $ivps1/g" /root/izin-xnxx/ip
git add .
git commit -m renew
git branch -M ipuk
git remote add origin https://github.com/${USERGIT}/izin-xnxx.git
git push -f https://${APIGIT}@github.com/${USERGIT}/izin-xnxx.git
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
Isadmin=$(curl -sS https://raw.githubusercontent.com/bezzo9699/izin-xnxx/main/ip | grep $MYIP | awk '{print $5}')
if [ "$Isadmin" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
